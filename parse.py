...
def extract_codes(codes_text):
    ...
    siret_codes = re.findall(r"[0-9]{12}", codes_text)
    ...
    for siren_code in siren_codes:
        codes_text = codes_text.replace(siren_code, '')
    NAF_codes = re.findall(r"[0-9]{4}", codes_text)
    return siren_codes, siret_codes, NAF_codes
...
class Dataset:
    ...
    def save(self, path):
        ...
        try:
            ...
            print('Emission data is parcellar, skipping')
        ...
        try:
            ...
            print('Assessment data is parcellar, skipping')
        ...
        try:
            ...
            print('Legal unit data is parcellar,skipping')
        ...
        for text_div_id in sorted(text_ids):
            ...
            if text != '':
                ...
                if text_div_id == 'bloc-m-siret':
                    siren_codes, siret_codes, NAF_codes = extract_codes(text)
                    for siren_code in siren_codes:
                    ...
                    for NAF_code in NAF_codes:
                        db.append('legal_units', is_published, {
                            'assessment_id': index,
                            'legal_unit_id_type': 'NAF',
                            'legal_unit_id': NAF_code,
                        })
